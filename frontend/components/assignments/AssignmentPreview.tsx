...
export function AssignmentPreview({ paper }: AssignmentPreviewProps) {
  ...
  return (
    <div className="w-full py-4 select-text">
      <div id="printable-paper" className="w-full sm:w-[800px] min-h-[1130px] mx-auto bg-white border border-neutral-300 shadow-[0_12px_40px_rgba(0,0,0,0.08)] p-4 sm:p-12 flex flex-col justify-between font-serif text-neutral-800 text-sm leading-relaxed">
        <div>
